...
df_train$random_var1 <- rescale(r(Norm(mean = 7, sd = 3))(nrow(df_train)), to = c(1,10))
df_train$random_var2 <- sample(c(1:4), nrow(df_train), replace = T)
set.seed(123)
rf <- randomForest(formula =  cotm ~ ., data  = df_train,
                   importance = TRUE)
varImpPlot(rf)
...
Check out [treeheatr](https://trang1618.github.io/treeheatr/) here!
